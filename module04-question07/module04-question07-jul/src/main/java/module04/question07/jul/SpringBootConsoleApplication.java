package module04.question07.jul;
...
public class SpringBootConsoleApplication implements CommandLineRunner {
    ...
    public static void main(String[] args) throws IOException {
        // to use Java Util Logging we first need to exclude the default logging configuration for spring (pom.xml)
        // then initialize JDK logging configuration
