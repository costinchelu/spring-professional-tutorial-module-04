package module04.question22.mysql;
...
public class MySqlAutoConfiguration {
    ...
    private DriverManagerDataSource getConfiguredDataSource() {
        ...
        dataSource.setUrl(String.format("jdbc:mysql://%s:%d/%s?useSSL=false", mySqlProperties.getHost(), mySqlProperties.getPort(), mySqlProperties.getDbname()));
